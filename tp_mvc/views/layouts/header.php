...
<head>
  ...
  <title>TP MVC - Student Management System</title>
</head>

<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="index.php">TP MVC</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link <?php echo (!isset($_GET['action']) || $_GET['action'] == 'students') ? 'active' : ''; ?>" aria-current="page" href="index.php?action=students">Students</a>
          </li>
          <li class="nav-item">
